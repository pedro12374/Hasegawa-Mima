...
fig.set_size_inches(30*0.393, 15*0.393) # esse fatir 0.393 é p converter polegadas p cm

#ax.set_ylabel(r"$y$") # Legenda, p renderizar direito precisa do r"$blablabla$"
#ax.set_xlabel(r"$x$")

t,x,y = np.loadtxt("ondas.dat",delimiter="\t",unpack=True)#vermelho
...
ax[0].scatter(x, y,  marker='o', s=(1./fig.dpi)**2)
#ax.plot(x,y,"k,")
